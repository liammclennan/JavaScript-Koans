...
test("replace", function() {
    ...
    pie = "what is 6 turned out to be 9?".replace(/\d/g, function(number) { // the second parameter can be a string or a function
        var map = {'6': 'six','9': 'nine'};
        return map[number];
    });
    equal("what is six turned out to be nine?", pie, 'what is the value of pie?');
});
