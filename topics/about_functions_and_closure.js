...
test('defining functions directly', function () {
  ...
  // the ability to access a variables defined in the same scope as the function
  // is known as 'closure'
...
test('using call to invoke function', function () {
  ...
  //   you to set the callers "this" context.
  // call can take any number of arguments:
  //   the first one is always the context that this should be set to in the called
  //   function, and the arguments to be sent to the function, multiple arguments
...
test('using apply to invoke function', function () {
  ...
  // similar to the call function is the apply function. 
  // apply only has two arguments: 
  //   the first is the context that this should be set to in the called
